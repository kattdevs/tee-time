...
const uiSlice = createSlice({
    ...
    initialState: {
        modalOpen: false,
        selectedSlot: null, //time string e.g '07:00'
        toast: {visible: false, message: '', type: 'success'},
    },
    reducers: {
        openModal: (state, a) => {state.modalOpen = true; state.selectedlot = a.payload;},
        closeModal: state => {state.modalOpen = false; state.selectedSlot = null;},
        showToast: (state, a) => {state.toast = {visible: true, ...a.payload};
    },
